...
class TanggunganModel(db.Model):
    __tablename__= 'tb_tanggungan'
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    jml_tanggungan = db.Column(db.String(32), nullable=False)
    
    def __repr__(self) -> str:
        return 'id = {}, jumlah tanggungan = {}'.format(self.id, self.jml_tanggungan)